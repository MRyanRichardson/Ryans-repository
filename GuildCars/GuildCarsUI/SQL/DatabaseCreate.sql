...
CREATE DATABASE [GuildCars]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'GuildCars', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL11.DLR\MSSQL\DATA\GuildCars.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'GuildCars_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL11.DLR\MSSQL\DATA\GuildCars_log.ldf' , SIZE = 6272KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
GO

ALTER DATABASE [GuildCars] SET COMPATIBILITY_LEVEL = 110
GO
...
ALTER DATABASE [GuildCars] SET AUTO_CREATE_STATISTICS ON 
GO
